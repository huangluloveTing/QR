...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, self.numberColor.CGColor);
    ...
    [numberText drawInRect:CGRectInset(rect, (CGRectGetWidth(rect) - sz.width)/2.0f, (CGRectGetHeight(rect) - sz.height)/2.0f) withAttributes:
     @{NSForegroundColorAttributeName:self.numberColor, NSFontAttributeName:self.numberFont}];
...
- (void)setup {
    ...
    //< Default Parameters
    self.numberColor = [UIColor colorWithWhite:0.9 alpha:0.7];
    self.numberFont = [UIFont fontWithName:@"Courier-Bold" size:25.0f];
    self.circleColor =  [UIColor colorWithWhite:1 alpha:0.7 ];
    self.circleBorderWidth = 2;
